...
function Login(props) {
    ...
    <div className={classes.paper}>
      ...
      {props.error == null ? null : (
        <div className={classes.alert}>
          {" "}
          <Alert severity="error">Username or passwor is wrong!</Alert>{" "}
        </div>
      )}
  ...
  if (props.isAuthenticated) {
    props.onAlert("You have been logged in successfully", username.value);
    homePageRedirect = <Redirect to="/main-page" />;
  }
  if (props.loading) {
    form = (
      <div className={classes.paper}>
