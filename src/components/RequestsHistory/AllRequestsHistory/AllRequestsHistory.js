...
import AllArtifactRequestsHistory from "./AllArtifactRequestsHistory";
import AllTraceabilityRequestsHistory from "./AllTraceabilityRequestsHistory";
...
function AllRequestsHistory(props) {
...
export default connect(mapStateToProps, mapDispatchToProps)(AllRequestsHistory);
